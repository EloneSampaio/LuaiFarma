...
$(".addmore").on('click',function(){
	...
	html += '<td><input type="text" name="batch[]" id="batch" class="form-control autocomplete_txt" autocomplete="off"></td>';html += ' <td><input type="number" step="any" name="cost_price[]" id="cost_price" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"  ></td>';
	html += '<td><input type="text" step="any" name="sell_price[]" id="sell_price" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"  ></td>';
	html += ' <td><input type="text" step="any" name="cost_price[]" id="cost_price" class="form-control changesNo"   ></td>';
	html += '<td><input type="text" step="any" name="supplier[]" id="supplier" class="form-control autocomplete_txt" autocomplete="off"   ></td>';
