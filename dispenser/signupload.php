         ...
         <!-- general form elements -->
          <div class="box box-primary">
			...
			<?php
				...
				mysqli_query($con, "insert into users (name,userid,password,level,mail) values('$name','$userid','$password','$level','$mail')")or die(mysql_error());
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
					...
					<tbody>
						...
						$query=mysqli_query($con, "SELECT name, id, mail, userid, password, level  FROM `users` ORDER BY id DESC  LIMIT 10")or die(mysqli_error());
