...
<div class="table-responsive">
                        <table class="table table-bordered table-striped" id="example">
                            ...
                            <tbody>
								...
								$result= mysqli_query($con, "select c.trade_name, c.generic_name, i.id, i.batch, i.cost_price, i.sell_price, i.quantity, i.qty_sold, date_format(i.datetime, '%d/%m/%y') AS DATE, i.expiry_date FROM `medicine_list` AS c INNER JOIN `inventory` AS i ON c.sno = i.sno  ORDER BY i.id Desc" ) or die (mysql_error());
