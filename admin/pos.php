				...
				<div class="col-xs-6">
					...
					<div class="col-xs-6">	<h4>&nbsp;</h4>
						<div class="input-group">
							<div class="input-group-addon">Receipt No.</div>
							<input type="text" class="form-control" name="invoiceNo" id="invoiceNo" value="<?php echo $_GET['invoice']; ?>" readonly>
</div>
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" name="date" id="to" value="<?php echo date("d/m/Y");  ?>" readonly>
					...
					<div class="col-xs-5">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="number" class="form-control" name="total" id="totalAftertax" placeholder="Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
								</div>
							</div>
