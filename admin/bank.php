          ...
          <div class="box box-primary"></br>
           ...
           <form role="form" method="post"  name='form1'  action="bank.php"  onsubmit="return validate()">
			...
			<?php
				...
				mysqli_query($con, "insert into bank (name,ac_no, branch) values('$name','$ac_no','$branch')")or die(mysqli_error());
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
					...
					<tbody>
						...
						$query=mysqli_query($con, "SELECT b.name, b.ac_no, b.branch, b.id , sum(d.deposit) AS Total FROM `bank` AS b INNER JOIN `bank_deposit` AS d ON b.id=d.name GROUP BY b.id")or die(mysqli_error());
					...
					<thead>
		<tr>
			<th colspan="3" style="border-top:1px solid #999999"> Total Cash in Bank </th>
