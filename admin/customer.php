          ...
          <div class="box box-primary">
           ...
           <form role="form" method="post" name='form1'  action="customer.php" >
              <div class="box-body">
                ...
                <div class="form-group">
				<label for="exampleInputEmail1">Medicine Requirements</label>
                  <input type="text"  name="medicine" class="form-control" id="skills" placeholder="Enter Medicine" required>
                </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
					...
					<tbody>
						...
						$query=mysqli_query($con, "SELECT *  FROM `customer`   LIMIT 10")or die(mysqli_error());
