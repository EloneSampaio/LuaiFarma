...
<br>
        ...
        $retail=$_POST['retail'];
				...
				mysqli_query($con, "insert into medicine_list (trade_name,generic_name,type,sell_price) values('$trade_name','$generic_name','$type','$retail')")or die(mysqli_error());
...
<div ng-controller="customersCrtl">
    ...
    <div class="row">
        <div class="col-md-12" ng-show="filteredItems > 0">
            ...
            <th>Retail Price&nbsp;<a ng-click="sort_by('generic_name');"><i class="glyphicon glyphicon-sort"></i></a></th>
            </thead>
            <tbody>
