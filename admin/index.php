        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-solid bg-teal-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title">Top 3 Users All time Sales</h3>
...
<script type="application/javascript">
    ...
    user_chart.data = [
    <?php
    $query = mysqli_query($con, "SELECT entrant, sum(amount) AS Total FROM sales_list  GROUP BY entrant ORDER BY Total DESC LIMIT 3") or die(mysqli_error());
    while ($row = mysqli_fetch_array($query)) {
        ?>
        <?php echo  $row['Total'] . ','; ?>
    <?php }; ?>
