        ...
        <div class="box-body">
         <!-- general form elements -->
          <div class="box box-primary">
			...
			<?php
	$id=$_GET['id'];
	$result = $dbo->prepare("select c.trade_name, c.generic_name, i.batch, i.id, i.cost_price, i.sell_price, i.quantity, i.qty_sold, i.expiry_date FROM `medicine_list` AS c INNER JOIN `inventory` AS i ON c.sno = i.sno   WHERE id= :userid");
           ...
           <form role="form" method="post"  action="updateproduct.php"   onsubmit="return validate()">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <input type="text"  name="sell_price"  class="form-control" id="txt1"  onkeyup="sum();" value="<?php echo $row['sell_price']; ?>">
                </div>
